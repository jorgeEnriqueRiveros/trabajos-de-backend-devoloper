...
const productosLacteosMenos5 = productos.filter(producto => producto.categoria === "Lácteos" && producto.precio < 5.0);
const productosModificados = productosLacteosMenos5.map(producto => {
    const nuevoPrecio = producto.precio * 0.20;

/* 1.  Filtrar Productos por Categoría: Crear una función que permita filtrar los productos 
por una categoría específica, como "Lácteos" o "Bebidas".
*/
const productos = [
    {
        id: "001",
...
const categoriaElegida = "Bebidas";

const productosFiltrados = filtrarPorCategoria(productos, categoriaElegida);


console.log(`Productos de la categoría "{categoriaElegida}":`, productosFiltrados);

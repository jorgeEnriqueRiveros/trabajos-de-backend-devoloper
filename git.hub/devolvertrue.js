...
function existeCategoriaBebidasAlcoholicas(productos) {
    return productos.some(producto => producto.precio <= 10);
}

const hayBebidasAlcoholicas = existeCategoriaBebidasAlcoholicas(productos);

console.log(hayBebidasAlcoholicas);

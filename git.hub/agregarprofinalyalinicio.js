...
const nuevoProductoFinal = {
   
};

function nuevoProducto ( id: "012",
nombreProducto: "Miel de Abeja",
descripcion: "Miel de abeja natural, 250g",
foto: "https://picsum.photos/id/1/200/300",
...
console.log()
/*
const productosAlPrincipio = [nuevoProductoInicio, ...productos];

const productosActualizados = [...productosAlPrincipio, nuevoProductoFinal];

// Calcular el promedio de precio de los productos que no tengan impuestos. **filter, reduce**
const productos = [
    {
        id: "001",
...
function sumarProductosPorImpuesto(impuesto) {
    const productoFiltrado = productos.filter(producto => producto.impuesto === impuesto).reduce((sumar, producto) => sumar + producto.precio, 0)
    console.log(productoFiltrado);
}
sumarProductosPorImpuesto(0)
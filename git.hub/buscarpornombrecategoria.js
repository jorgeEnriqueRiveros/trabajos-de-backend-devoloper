...
function sumarPorImpuesto(valor){
const total =productos.filter(producto=>producto.precio>=valor).reduce((sumarImpuesto, producto)=>sumarImpuesto+=producto.impuesto,0)
console.log(total)
}
